                ...
                <div className="px-1 md:px-3  pt-1 md:pt-3 md:pb-3 pb-2">
                  ...
                  <div className="mt-1 md:mt-3 flex gap-x-2 md:gap-x-3">
                    {product.stock ?
                      ...
                      <button onClick={() => cartHandle(product._id, 1)} className="bg-slate-800  font-medium text-white flex w-[70%] md:w-[85%] justify-center h-8 md:h-auto md:py-2 items-center rounded-md text-center">
                        <p>
                          <BiPlus className="text-lg md:text-2xl mr-1 md:mr-2" />
                        </p>
                        <p className='text-xs md:text-base'>Add To Cart</p>
                      </button>
                      :
                      <p className="bg-slate-800  font-medium text-white flex w-[70%] md:w-[85%] justify-center h-8 md:h-auto md:py-2 items-center rounded-md text-center">
                        Out of Stock
                      </p>
                    }

                    <button onClick={() => wishlistHandle(product._id)} className="border-2 bg-gray-100 font-medium w-[30%] md:w-[15%] flex  justify-center h-8 md:h-auto md:py-2 items-center rounded-md text-center">
