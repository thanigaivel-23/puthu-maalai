...
import watch2 from "../../../assets/img/product page/2.jpg";
import watch4 from "../../../assets/img/product page/4.jpg";
import watch5 from "../../../assets/img/product page/5.jpg";
      ...
      <Slider className="xl:w-[98%] mb-10 md:mb-14 lg:mb-20" {...settings}>
        <div className="w-[25%] mt-10 flex justify-center flex-col relative border-2">
          ...
          <div className="lg:px-3 lg:pt-3 lg:pb-3">
            ...
            {/* ratings */}
            <p className="flex justify-between flex-col lg:flex-row -ml-2 mt-1 pl-1 text-xs md:text-base">
            ...
            {/* cart n wishlist */}
            <p className="mt-3 flex lg:gap-x-3 mb-2 -ml-2">
