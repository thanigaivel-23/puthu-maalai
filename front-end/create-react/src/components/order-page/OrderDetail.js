                        ...
                        <div className='mt-5 '>
                            ...
                            <div className='border-t-8 border-[#f5f5f5] pl-5'>
                                ...
                                <Modal title="Rate Product" open={isModalOpen} footer={false} onCancel={() => setIsModalOpen(false)} >
                                    ...
                                    <textarea onChange={(e) => setComment(e.target.value)} rows={'8'} className="w-full outline-none border rounded-md p-2 " placeholder="Please write product review here" defaultValue={updatingReview.length > 0 ? updatingReview[0].comment : ''}></textarea>
