...
const CreateProduct = () => {
    ...
    return (
        <>
            ...
            {/*create product*/}
            <form className='md:border-2 md:w-[70%] lg:w-[50%] md:mx-auto md:my-7'>
                ...
                <input onChange={(e) => setName(e.target.value)} value={name} type="text" placeholder='Enter Product Name' required className='outline-none border rounded-sm box-border w-11/12 mx-3 mb-3 px-3 py-2 focus:border-gray-700 placeholder:text-sm' />

                {/* price */}
                <p className='mx-3 py-3 text-sm md:text-base font-bold text-gray-700 '>Price</p>

                <input onChange={(e) => setPrice(e.target.value)} value={price} onch type="number" placeholder='Enter Productn Price Without Discount ' required className='outline-none border rounded-sm box-border w-11/12 mx-3 mb-3 px-3 py-2 focus:border-gray-700 placeholder:text-sm' />

                <input onChange={(e) => setDiscount(e.target.value)} value={discount} type="number" placeholder='Enter Discount in %' required className='outline-none border rounded-sm box-border w-11/12 mx-3 mb-3 px-3 py-2 focus:border-gray-700 placeholder:text-sm' />
                ...
                <textarea onChange={(e) => setDescription(e.target.value)} value={description} cols="20" rows="6" required placeholder='Description' className='outline-none border rounded-sm box-border w-11/12 mx-3 mb-3 px-3 py-2 focus:border-gray-700 placeholder:text-sm'></textarea>

                <input onChange={(e) => setStock(e.target.value)} value={stock} type="number" placeholder='Stock' required className='outline-none border rounded-sm box-border w-11/12 mx-3 mb-3 px-3 py-2 focus:border-gray-700 placeholder:text-sm' />

                <input onChange={(e) => setSellerName(e.target.value)} value={sellerName} type="text" placeholder='Seller Name' required className='outline-none border rounded-sm box-border w-11/12 mx-3 mb-3 px-3 py-2 focus:border-gray-700 placeholder:text-sm' />
                ...
                <input onChange={(e) => setCategory(e.target.value)} value={category} type="text" placeholder='Category' required className='outline-none border rounded-sm box-border w-11/12 mx-3 mb-3 px-3 py-2 focus:border-gray-700 placeholder:text-sm' />
                ...
                <div className='m-3 mb-9 w-11/12 flex'>
                    ...
                    <input onChange={imageHandler} id='product_img' type="file" multiple required className='hidden' />
                </div>
